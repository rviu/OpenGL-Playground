...
int main() {
  ...
  GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Awesome container", NULL, NULL);
  ...
  unsigned char* data = stbi_load("data/container.jpg", &width, &height, &n_channels, 0);
